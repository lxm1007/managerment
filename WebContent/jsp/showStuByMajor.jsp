...
<form class="form-inline" action="${path}/serachByMajor">
  <div class="form-group">
    <label class="sr-only" for="exampleInputEmail3">专业</label>
...
<td><input class="form-control inp" value="${list.stu_major}"></td>
...
$(".update").click(function(){
	...
	$.ajax({
		url:"${path}/updateStuMajor?id="+val1+"&&major="+val2,
		type:"POST",
