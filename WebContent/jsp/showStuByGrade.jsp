...
<form class="form-inline" action="${path}/serachByGrade">
  <div class="form-group">
    <label class="sr-only" for="exampleInputEmail3">年级</label>
...
<td><input class="form-control inp" value="${list.stu_grade}"></td>
...
$(".update").click(function(){
	...
	$.ajax({
		url:"${path}/updateStuGrade?id="+val1+"&&grade="+val2,
		type:"POST",
