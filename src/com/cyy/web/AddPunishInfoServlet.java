...
/**
 * Servlet implementation class AddPunishInfoServlet
 */
@WebServlet("/addPunishInfo")
public class AddPunishInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			boolean f = stuService.addPunishInfo();
		} catch (Exception e) {
